...
final class AssemblyAIStreamingTranscriptionProvider: BuddyTranscriptionProvider {
    ...
    private static let tokenProxyURL = "https://clicky-proxy.flowcap.workers.dev/transcribe-token"
    ...
    private func fetchTemporaryToken() async throws -> String {
        ...
        let authToken = AppBundleConfiguration.stringValue(forKey: "WorkerAuthToken") ?? ""
